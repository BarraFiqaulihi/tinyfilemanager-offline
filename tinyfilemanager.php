...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    ?>
    <link href="src/dropzone/5.9.3/min/dropzone.min.css" rel="stylesheet">
    <div class="path">
    ...
    <script src="src/dropzone/5.9.3/min/dropzone.min.js"></script>
    <script>
...
<head>
    ...
    <link href="src/bootstrap/5.2.2/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    <style>
...
<script src="src/bootstrap/5.2.2/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <link href="src/bootstrap/5.2.2/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    <link rel="stylesheet" href="src/font-awesome/4.7.0/css/font-awesome.min.css" crossorigin="anonymous">
    <?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])): ?>
    <link rel="stylesheet" href="src/hightlight.js/11.7.0/styles/<?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
...
<script src="src/jquery/jquery-3.6.1.min.js" crossorigin="anonymous"></script>
<script src="src/bootstrap/5.2.2/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
<script src="src/DataTables/DataTables-1.13.1/js/jquery.dataTables.min.js" crossorigin="anonymous" defer></script>
<?php if (FM_USE_HIGHLIGHTJS && isset($_GET['view'])): ?>
    <script src="src/hightlight.js/11.7.0/highlight.min.js"></script>
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE && !FM_READONLY):
        ...
        ?>
    <script src="src/ace/builds-1.5.0-src-min/ace.js"></script>
    <script>
